...
\songcolumns{1}
\beginsong
{Sonho por Sonho %TÍTULO
}[by={Leandro e Leonardo %ARTISTA
},album={@walyssondosreis},
id={\href{https://music.youtube.com/watch?v=Y-TY4dWF3-0&feature=share %LINK
}{ST0012 %COD.ID.: XXNNNN
}},rev={5}, %REVISÃO
qr={https://music.youtube.com/watch?v=Y-TY4dWF3-0&feature=share %LINK
}]
%-----------------------------------------------------------------
\tom{}{E}
%=================================================================
