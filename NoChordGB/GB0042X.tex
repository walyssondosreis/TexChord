...
\songcolumns{1}
\beginsong
{Eu Vou Viver Uma Virada %TÍTULO
}[by={Toque no Altar %ARTISTA
},album={@walyssondosreis},
id={GB0042 %COD.ID.: GB0000
},rev={0}, %REVISÃO
qr={https://drive.google.com/open?id=1C4JEeM3SK1xR00cBo4w_72a3Wr8KpgwG %LINK
}]
%-----------------------------------------------------------------
\tom{X1}{B}
%=================================================================
